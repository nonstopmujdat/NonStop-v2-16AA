...
export default async function FoulMapPdfPage({ params }: { params: { matchId: string } }) {
  ...
  return (
    <main className="dashboard printable-report">
      <div className="topbar no-print"><b>Faul Haritası PDF</b><div style={{ display: 'flex', gap: 12 }}><button id="printFoulButton">Yazdır</button><Link href="/full-admin/reports">Geri</Link></div></div>
