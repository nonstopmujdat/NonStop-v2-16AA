    ...
    <main className="dashboard">
      <div className="topbar">
        ...
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          ...
          <Link href="/full-admin/reports">PDF Raporlar</Link>
        </div>
      </div>
      ...
      <section className="grid two" style={{ marginTop: 18 }}>
        ...
        <form className="card" action="/api/full-admin" method="post">
          ...
          <label>A/B Grubu</label>
          <select name="league_level_info" defaultValue="NONE"><option value="NONE">Yok / Seçilmedi</option><option value="A">A Grubu</option><option value="B">B Grubu</option></select>
          <small>Not: A/B grubu resmi olarak lig/organizasyon ekranında kullanılır.</small>
          <label>Sezon</label>
