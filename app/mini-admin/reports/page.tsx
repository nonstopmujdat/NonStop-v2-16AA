  ...
  return (
    <main className="dashboard">
      ...
      <section className="card">
        ...
        <p>Maç istatistik raporu ve saha üzeri şut/atış haritası ayrı ayrı yazdırılabilir. Tarayıcıdan <b>Yazdır → PDF olarak kaydet</b> seç.</p>
      </section>
        ...
        <div style={{ overflowX: 'auto' }}>
          <table>
            ...
            <tbody>{matches.map((m) => <tr key={m.match_id}>
              ...
              <td style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}><Link href={`/mini-admin/reports/${m.match_id}/stats`}>İstatistik PDF</Link><Link href={`/mini-admin/reports/${m.match_id}/shots`}>Şut Haritası PDF</Link></td>
            </tr>)}</tbody>
          </table>
        </div>
      </section>
